...
public class UserDao {
    ...
    public List<Certification> getCertificationList() {
        ...
        PreparedStatement ps = null;
        conn = connDB.getConnection();
        List<Certification> pdfInfos = new ArrayList<Certification>();

        String sql = "SELECT file_name,file_url,icon FROM information WHERE icon IS NOT NULL AND icon <> ''";
        // 调用SQL
        try {
            ...
            while (rs.next()) {
                Certification pdfInfo = new Certification();

                pdfInfo.setName(rs.getString("file_name"));
                pdfInfo.setFileUrl(rs.getString("file_url"));
                pdfInfo.setIcon(rs.getString("icon"));
    ...
    public String gainHospitalId(String name) {
        ResultSet rs = null;
        PreparedStatement ps = null;
        conn = connDB.getConnection();
        List<PdfInfo> pdfInfos = new ArrayList<PdfInfo>();

        String sql = "SELECT hospitalid FROM hospital h,account a WHERE h.name = ? AND a.accountid=h.account_id OR  a.accountid=h.account_id AND a.username=?";
        // 调用SQL
        try {
     ...
     * 获取角色
     */
    public void insertMUser(String name, String phone, String email,
                            String unit, String job) {
        ResultSet rs = null;
        PreparedStatement ps = null;
        conn = connDB.getConnection();
        List<Role> roles = new ArrayList<Role>();

        String sql = "INSERT INTO m_user(name,phone,email,unit,job) VALUES(?,?,?,?,?)";
        // 调用SQL
        try {
     ...
     * 获取角色
     */
    public UserInfo getContact(String phone) {
        ResultSet rs = null;
        PreparedStatement ps = null;
        conn = connDB.getConnection();
        UserInfo userInfo = null;

        String sql = "SELECT true_name,phone FROM users WHERE hospital_id = ( SELECT hospital_id FROM users WHERE phone = ?) AND role_id = 3";
        // 调用SQL
        try {
            ...
            if (rs.next()) {
                ...
                userInfo.setTrueName(rs.getString("true_name"));
     ...
     * 根据手机修改信息
     */
    public IosUpload gainIosUpdate() {
        IosUpload iosUpload = new IosUpload();
        ResultSet rs = null;
        PreparedStatement ps = null;
        conn = connDB.getConnection();
        int result = 0;

        String sql = "SELECT * FROM ios_upload WHERE  `type`='ios' ";
        // 调用SQL
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                iosUpload.setTitle1(rs.getString("title1"));
                iosUpload.setContent1(rs.getString("content1"));
                iosUpload.setTitle2(rs.getString("title2"));
                iosUpload.setContent2(rs.getString("content2"));
                iosUpload.setTitle3(rs.getString("title3"));
                iosUpload.setContent3(rs.getString("content3"));
                iosUpload.setTitle4(rs.getString("title4"));
     ...
     * @return
     */
    public long insertGuarantee(String boxNo, String phone, String content,
                                String hospitalId) {
        ResultSet rs = null;
        PreparedStatement ps = null;
        conn = connDB.getConnection();

        String sql = "INSERT INTO guarantee(box_no,phone,reason,hosp_id) VALUES(?,?,?,?)";
     ...
     * @return
     */
    public long insertGuaranteeFiles(int gid, String name, String path) {
        ResultSet rs = null;
        PreparedStatement ps = null;
        conn = connDB.getConnection();

        String sql = "INSERT INTO guarantee_files(gid,name,path) VALUES(?,?,?)";
    ...
    public int updatePhoneUrl(String path, String phone, String flag) {
        ...
        try {
            ...
            try {
                ...
                wangyiHttpUtils.updateUinfo(phone, path);
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    public static void main(String[] args) {
        boolean isOK = new UserDao().loginWeb("中国移植器官转运及质控平台OTQC", "888888");
    ...
    public String gainScreenName() {
        ...
        try {
            ...
            String sql = "SELECT name FROM screen";
            ps = conn.prepareStatement(sql);
    ...
    public void updateScreen(String name) {
        ...
        try {
            ...
            String sql = "UPDATE screen SET name=?";
            ps = conn.prepareStatement(sql);
            ps.setString(1, name);
            ps.executeUpdate();
    ...
    public void insertRedpacklog(int price, String name, String phone, int transferid, String create_time, String transferNumber) {
        ResultSet rs = null;
        PreparedStatement ps = null;
        conn = connDB.getConnection();
        ...
        try {
            ...
            String sql = "INSERT INTO redpacklog(price,name,phone,transferid,create_time,transferNumber) VALUE(?,?,?,?,?,?)";
            ps = conn.prepareStatement(sql);
            ps.setInt(1, price);
            ps.setString(2, name);
            ps.setString(3, phone);
