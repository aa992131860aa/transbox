...
public class ContactDao {
	...
	public List<ContactPerson> findFriends(String phone, String name)
		...
		try {
			...
			//System.out.println("contact.do sql:" + sql + ",size:"+ contactPersons.size());
			return contactPersons;

		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			//System.out.println("contact.do search:" + e.getMessage());
			return contactPersons;
		} finally {
	 ...
	 * @return
	 */
	public List<Contact> getContactList(String phone,String organSeg) {
		...
		try {
			...
			while (rs.next()) {
				...
				if (rsTwo.next()) {
					...
					//System.out.println(contact.getPostRole());
				}
