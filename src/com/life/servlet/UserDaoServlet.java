...
//		response.addHeader("Access-Control-Allow-Methods", "GET,POST,PUT,DELETE");
        ...
        if (action != null) {
            ...
            // 设置是否自动更新
                ...
                IosUpload iosUpload = userDao.gainIosUpdate();

                datas.setResult(CONST.SEND_OK);
                datas.setMsg("更新自动成功");
                datas.setObj(iosUpload);
            ...
            // 获取角色列表
            else if ("insertMUser".equals(action)) {
                Datas datas = new Datas();
                ...
                userDao.insertMUser(name, phone, email, unit, job);
            ...
            // 删除系统消息
                ...
                out.write(gson.toJson(datas));
            } else if ("screenName".equals(action)) {

                Datas datas = new Datas();

                String name = userDao.gainScreenName();
                datas.setObj(name);
                out.write(gson.toJson(datas));
            } else if ("upateScreenName".equals(action)) {


                String name = request.getParameter("name");
                userDao.updateScreen(name);

            } else if ("insertRedpacklog".equals(action)) {
                ...
                String transferNumber = request.getParameter("transferNumber");

                userDao.insertRedpacklog(Integer.parseInt(price), name, phone, Integer.parseInt(transferid), create_time, transferNumber);
