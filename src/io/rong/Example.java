...
//		
		// 检查用户在线状态 方法 
//		CheckOnlineResult userCheckOnlineResult = rongCloud.user.checkOnline("18398850872");
...
//		String[] messagePublishPrivateToUserId = {"18398850875","userid3","userId4"};
//		VoiceMessage messagePublishPrivateVoiceMessage = new VoiceMessage("hello", "helloExtra", 20L);
//		CodeSuccessResult messagePublishPrivateResult = rongCloud.message.publishPrivate("18398850872", messagePublishPrivateToUserId, messagePublishPrivateVoiceMessage, "thisisapush", "{\"pushData\":\"hello\"}", "4", 0, 0, 0, 0);
...
//		// 发送群组消息方法（以一个用户身份向群组发送消息，单条消息最大 128k.每秒钟最多发送 20 条消息，每次最多向 3 个群组发送，如：一次向 3 个群组发送消息，示为 3 条消息。） 
		String[] messagePublishGroupToGroupId = {"123"};
		//"thisisapush", "{\"pushData\":\"hello\"}"
		//TxtMessage messagePublishGroupTxtMessage = new TxtMessage("hello", "helloExtra");
		CodeSuccessResult messagePublishGroupResult = rongCloud.message.publishGroup("18398850872", messagePublishGroupToGroupId, new DizNtfMessage(), "thisisapush", "", 1, 1, 0);
...
//		CodeSuccessResult messagePublishDiscussionResult = rongCloud.message.publishDiscussion("admin", "ae7e25e0-f920-464e-93f2-182d7c67a18d", messagePublishDiscussionTxtMessage, "thisisapush", "{\"pushData\":\"hello\"}", 1, 1, 1);
...
//		
//		// 查询群成员方法 
//		GroupUserQueryResult groupQueryUserResult = rongCloud.group.queryUser("ab54c50a-5385-4eee-9773-042493ec6065");
